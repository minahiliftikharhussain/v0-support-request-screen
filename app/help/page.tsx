          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {helpCategories.map((category, index) => (
              <Card key={index} className="p-6 hover:shadow-lg transition-shadow cursor-pointer group">
                ...
                <Link href={category.link} className="text-primary hover:underline text-sm font-medium">
                  Learn More →
                </Link>
              </Card>
            ))}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {resources.map((resource, index) => (
              <Card key={index} className="p-6 hover:shadow-lg transition-shadow">
                ...
                <Link href={resource.link} className="text-primary hover:underline text-sm font-medium">
                  View Guide →
                </Link>
              </Card>
            ))}
